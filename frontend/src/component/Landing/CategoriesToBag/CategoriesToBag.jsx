...
const CategoriesToBag = () => {
      const images = [
        ...
        {
          id: 11,
          url: "https://assets.myntassets.com/f_webp,w_122,c_limit,fl_progressive,dpr_2.0/assets/images/2022/2/23/cd083042-3bb2-4231-8b96-0234fc0ed23f1645602467032-Jeans.jpg",
        },
        {
          id: 12,
  ...
  return (
    <>
      <div className={styles.heading}>Categories to bag</div>
